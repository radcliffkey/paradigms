...
public class MorphemeBoundaryTooFarRight_FilterMenu {
	...
	public MorphemeBoundaryTooFarRight_FilterMenu(BufferedReader stdin, 
	...
	private void doSetLeftLookingMetric() {
		...
		String instructions = "MBTF Right: Please select the left looking metric you would like to filter with";
	...
	private void doSetLeftLookingMetricCutoffs() {
		ListOfDoubleInputMenu listOfDoubleInputMenu = 
			new ListOfDoubleInputMenu(stdin, 
									  MENU_NAME, 
									  "MBTF Right: Left looking Metric Cutoff: Please enter a list of cutoffs " +
	...
	private boolean doMorphemeBoundaryTooFarRight_Filter() {
		...
		if ( ! (partialOrderNetwork instanceof VirtualPartialOrderNetwork)) {
			...
			System.err.println("  before you may perform a morpheme boundary too far right filtering");
			System.err.println();
		...
		System.err.println();
		System.err.println("Do you wish to perform a morpheme boundary too far right filtering with the");
		...
		if (filteringSucceeded) {
			System.err.println();
			System.err.println("Morpheme boundary too far right filtering complete.  ");
