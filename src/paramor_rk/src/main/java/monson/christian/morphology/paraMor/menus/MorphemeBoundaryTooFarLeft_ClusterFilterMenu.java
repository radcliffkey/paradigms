...
public class MorphemeBoundaryTooFarLeft_ClusterFilterMenu {
	...
	public MorphemeBoundaryTooFarLeft_ClusterFilterMenu(BufferedReader stdin, 
	...
	private boolean doMorphemeBoundaryTooFarLeft_Filter() {
		...
		if (filteringSucceeded) {
			System.err.println();
			System.err.println("Morpheme Boundary too far left filtering of Clusters complete.  ");
